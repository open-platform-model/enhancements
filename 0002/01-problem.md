...
The construct an author thinks of as "one deployed instance of a module" wears at least four inconsistent spellings across the stack, all built on the word "Release" the model is trying to move away from. This document leads with the names as they exist in `core/src` today; the rename mechanics belong in `02-design.md`.
