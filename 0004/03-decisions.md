...
**Rationale:** Crossing a major changes the import path (`@v0`→`@v1`) and requires code changes. That is a deliberate human action, not an auto-bump. Disabling major updates over the regex managers is the simplest correct guard.
