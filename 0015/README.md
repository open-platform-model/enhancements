...
Under 0019 D5 the inventory itself is a pure CUE fold over the platform's embedded catalogs, the same shape as the derived `#composedTransformers`.
...
**Registration CR and authoring (D3, D9-D12)**
