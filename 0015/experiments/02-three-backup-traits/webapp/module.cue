// Copied from experiment 01 webapp/module.cue, the advisory knob removed.
package webapp
...
import (
	...
	id "testing.opmodel.dev/experiments/0015/exp02/webapp/identity"
)
...
metadata: {
	...
	version:     id.Version
	description: "Experiment 0015/02 consumer: a workload with a volume that demands the backup trait"
}
