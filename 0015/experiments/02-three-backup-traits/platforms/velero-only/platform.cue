...
import (
	...
	velero "testing.opmodel.dev/experiments/0015/exp02/velero@v0"
)

core.#Platform
metadata: name: "velero-only"
type: "kubernetes"

#registry: {
	"opmodel.dev/catalogs/opm@v4": #catalog: opm
	"testing.opmodel.dev/experiments/0015/exp02/contracts@v0": #catalog: contracts
	"testing.opmodel.dev/experiments/0015/exp02/velero@v0": #catalog: velero
}
