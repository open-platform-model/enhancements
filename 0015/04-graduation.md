...
- **OQ9 and OQ10 are resolved or explicitly deferred with a written reason.** D5's guard is only as real as its detection: accepting the entry without a detection shape (OQ9) and site (OQ10) leaves the guard aspirational. (OQ1 is resolved-by-D5; OQ2 dissolved with the class rejection, resolved-by-D2.)
