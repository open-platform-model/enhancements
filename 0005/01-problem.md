...
Two Kubernetes-facing catalogs encode Kubernetes knowledge through independent, hand-maintained schema sources. This document lays out where they stand today and what that costs; the fix belongs in `02-design.md`.
