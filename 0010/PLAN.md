...
| operator-library-retarget | implementation | opm-operator | in-progress | library-core-retarget | Retarget to the core-v2 library line. Per the 2026-08-12 deviation the D14 filter->version CRD reshape rides this slice; otherwise no feature or adoption code (D18). Two OpenSpec changes; release waits for both.   |
