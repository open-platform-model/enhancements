...
- **`ModuleRelease` may be partially supported at first.** If OQ3 resolves to "Release-only in v1," `ModuleRelease` users get an inconsistent feature surface until a later slice.
