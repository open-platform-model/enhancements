# Delivery Plan — Module and Catalog Identity
...
graph LR
  ...
  X_artifact-publishing_core-identity-package["artifact-publishing:core-identity-package"]:::other
  X_artifact-publishing_core-identity-package -->|depends_on| S_core-alpha-release
  ...
  X_artifact-publishing_library-compat-comparator["artifact-publishing:library-compat-comparator"]:::other
  X_artifact-publishing_library-compat-comparator -->|depends_on| S_library-acquire-and-subscription
  ...
  X_artifact-publishing_catalogs-publish-cutover["artifact-publishing:catalogs-publish-cutover"]:::other
  X_artifact-publishing_catalogs-publish-cutover -->|depends_on| S_catalogs-republish
  ...
  X_artifact-publishing_modules-publish-cutover["artifact-publishing:modules-publish-cutover"]:::other
  X_artifact-publishing_modules-publish-cutover -->|depends_on| S_modules-fleet-republish
```
...
| library-acquire-and-subscription | implementation | library | done | library-core-retarget, artifact-publishing:library-compat-comparator | Identity verified where artifacts are read (modulePath vs fetched coordinate, version vs tag), and D14 deletes materialize/filter.go — no highestStable, no constraint solving; one major-agreement check survives beside the subscription.   |
...
| catalogs-republish | migration | catalog | done | catalogs-identity-authoring, catalogs-consolidation, artifact-publishing:catalogs-publish-cutover | Cut the release of the consolidated catalog_opm through `opm catalog publish`. The first act that changes a published artifact. (Was three catalogs until D47.)   |
| modules-fleet-republish | migration | modules | done | catalogs-republish, modules-identity-authoring, artifact-publishing:modules-publish-cutover | Republish the fleet through `opm module publish` against the released catalogs. The only fleet republish in the 0010/0011 pair.   |
