...
module: "experiments.opmodel.dev/0019/module-scale-cost/render@v0"
language: {
	version: "v0.17.0"
}
deps: {
	...
	"experiments.opmodel.dev/0019/module-scale-cost/mods@v0": {
		v: "v0.0.1"
	}
	"experiments.opmodel.dev/0019/module-scale-cost/platform@v0": {
		v: "v0.0.1"
	}
}
