...
Steps 1 and 2 were absent from this list until 2026-08-05, which read as though `cli` were the first mover; the delivery plan had the ordering right and its header recorded the discrepancy. Step 5's identity files were likewise claimed here and by 0010 at once — D17 settles that they are 0010's.
