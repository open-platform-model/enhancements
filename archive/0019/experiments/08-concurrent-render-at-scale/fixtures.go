...
// COPIED from experiments/07-module-scale-cost/fixtures.go, with only the
// module path renamed.
...
func materialize(fixtures, work string, points []point, n int, reuse bool) (*tree, bool, error) {
	...
	if err := cueModEdit(t.Render,
		"--replace=experiments.opmodel.dev/0019/concurrent-render-at-scale/mods@v0="+t.Mods,
		"--replace=experiments.opmodel.dev/0019/concurrent-render-at-scale/platform@v0="+t.Platform,
	); err != nil {
		return nil, false, err
	}
	return t, false, nil
